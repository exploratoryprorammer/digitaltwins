...
const Header: React.FC = () => {
  return (
    <AppBar position="static" color="primary" sx={{ backgroundColor: '#001E62' }}>
      <Toolbar>
        <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
          University of California San Francisco
        </Typography>
        <Button href="https://giving.ucsf.edu" color="secondary" variant="contained">
          Give to UCSF
        </Button>
      </Toolbar>
      <Toolbar sx={{ backgroundColor: '#F5F5F5', color: '#001E62' }}>
        <Box sx={{ display: 'flex', gap: 2, flexGrow: 1 }}>
          {['About', 'Patient Care', 'Research', 'Education', 'News & Media'].map((item) => (
